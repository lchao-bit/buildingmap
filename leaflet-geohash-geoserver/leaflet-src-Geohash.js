...
L.Map = L.Class.extend({
	...
	options: {
		crs: L.CRS.EPSG4326,//zc,change it to fit geohash projection //crs: L.CRS.EPSG3857,
...
L.extend(L.GeoJSON, {
	geometryToLayer: function (geojson, pointToLayer, coordsToLatLng, vectorOptions) {
		var geometry = geojson.type === 'Feature' ? geojson.geometry : geojson,
		    ...
		    coords = decode_geohashs(geometry.coordinates),
		    layers = [],
		...
		case 'LineString':
		  coords = decode_geohashsLine(geometry.coordinates),
 ...
 */
 L.GeohashLayer = L.Class.extend({
	...
	_update: function () {
		...
		var minb = L.CRS.EPSG4326.pointToLatLng(bounds.min,zoom),
				maxb = L.CRS.EPSG4326.pointToLatLng(bounds.max,zoom);
