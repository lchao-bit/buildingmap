...
var inputg = ["wx4etejn37p4sx","wx4etdvkwscy6e","wx4etdw5b7dy4b","wx4etdqspqkryn","wx4etdprj8y50z"];
var inputc = [116.2642539,40.0078033];
//decode_geohashs(inputg);
//encode_geohash(116.2642539,40.0078033,12);
decode_geohash("wx4enb09uqfryy");
var inputg = ["wx4dyzbeu76knc","wx4enb09uqfryy","wx4enb14ndv4hx","wx4dyzc5z76kp1","wx4dyzbeu76knc"];
decode_geohashs(inputg);
...
function decode_geohash(geohash)
{
	...
	console.log(lon[0], lon[1], lat[0], lat[1]);
}
...
function decode_geohashs(geohashs){
  ...
  var lat = [-90,90];
	...
	for(var k = 0;k<geohashs.length;k++){
		tmpg = geohashs[k];
		console.log(tmpg);
