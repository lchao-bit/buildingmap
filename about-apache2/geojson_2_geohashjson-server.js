...
//服务器测试路径
var map_file="/home/lchao/osm/geohash/"+filename+".json";
//本地测试路径
//var map_file="./"+filename+".json";
...
if(maps.length==0){
	...
	//fs.writeFile('./geohashjson'+'_file2',jsonstr,{flag:'a',encoding:'utf-8',mode:'0666'},function(err){});
...
function read_lonlat(line){
	...
	for(var i=0; i<path_string.length; i++){
		...
		for(var j = 0; j <coordinates.length; j++){
			...
			//console.log(j,point);
			//增加多维数组判断
			//console.log("point[0].constructor:"+point[0].constructor);
